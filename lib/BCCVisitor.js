...
// Visit a parse tree produced by BCCParser#bool.
BCCVisitor.prototype.visitBool = function(ctx) {
  return this.visitChildren(ctx);
};


// Visit a parse tree produced by BCCParser#datatype.
BCCVisitor.prototype.visitDatatype = function(ctx) {
  return this.visitChildren(ctx);
};
