...
var literalNames = [ null, "'true'", "'false'", null, "':'", "','", "';'", 
                     "':='", "'('", "')'", "'<'", "'<='", "'+='", "'-='", 
                     "'*='", "'/='", "'%='", "'!='", "'=='", "'>'", "'>='", 
                     "'{'", "'}'", "'+'", "'-'", "'*'", "'/'", "'%'", "'++'", 
                     "'--'", "'function'", "'var'", "'print'", "'input'", 
                     "'when'", "'do'", "'if'", "'else'", "'unless'", "'while'", 
                     "'return'", "'until'", "'loop'", "'repeat'", "'for'", 
                     "'end'", "'next'", "'break'", "'and'", "'or'", "'not'" ];

var symbolicNames = [ null, null, null, "DATATYPE", "TK_DOSPUNTOS", "TK_COMA", 
...
BCCParser.T__0 = 1;
BCCParser.T__1 = 2;
BCCParser.DATATYPE = 3;
BCCParser.TK_DOSPUNTOS = 4;
BCCParser.TK_COMA = 5;
BCCParser.TK_PUNTOYCOMA = 6;
BCCParser.TK_ASIGNACION = 7;
BCCParser.TK_PAR_IZQ = 8;
BCCParser.TK_PAR_DER = 9;
BCCParser.TK_MENOR = 10;
BCCParser.TK_MENOR_IGUAL = 11;
BCCParser.TK_SUM_ASIG = 12;
BCCParser.TK_RES_ASIG = 13;
BCCParser.TK_MUL_ASIG = 14;
BCCParser.TK_DIV_ASIG = 15;
BCCParser.TK_MOD_ASIG = 16;
BCCParser.TK_DIFERENTE = 17;
BCCParser.TK_IGUALDAD = 18;
BCCParser.TK_MAYOR = 19;
BCCParser.TK_MAYOR_IGUAL = 20;
BCCParser.TK_LLAVE_IZQ = 21;
BCCParser.TK_LLAVE_DER = 22;
BCCParser.TK_MAS = 23;
BCCParser.TK_MENOS = 24;
BCCParser.TK_MUL = 25;
BCCParser.TK_DIV = 26;
BCCParser.TK_MOD = 27;
BCCParser.TK_INCREMENTO = 28;
BCCParser.TK_DECREMENTO = 29;
BCCParser.FUNCTION = 30;
BCCParser.VAR = 31;
BCCParser.PRINT = 32;
BCCParser.INPUT = 33;
BCCParser.WHEN = 34;
    ...
    try {
        ...
        case BCCParser.TK_LLAVE_IZQ:
            ...
            do {
                ...
                this._errHandler.sync(this);
                _la = this._input.LA(1);
            } while(((((_la - 28)) & ~0x1f) == 0 && ((1 << (_la - 28)) & ((1 << (BCCParser.TK_INCREMENTO - 28)) | (1 << (BCCParser.TK_DECREMENTO - 28)) | (1 << (BCCParser.PRINT - 28)) | (1 << (BCCParser.INPUT - 28)) | (1 << (BCCParser.WHEN - 28)) | (1 << (BCCParser.DO - 28)) | (1 << (BCCParser.IF - 28)) | (1 << (BCCParser.UNLESS - 28)) | (1 << (BCCParser.WHILE - 28)) | (1 << (BCCParser.RETURN - 28)) | (1 << (BCCParser.UNTIL - 28)) | (1 << (BCCParser.LOOP - 28)) | (1 << (BCCParser.REPEAT - 28)) | (1 << (BCCParser.FOR - 28)) | (1 << (BCCParser.NEXT - 28)) | (1 << (BCCParser.BREAK - 28)) | (1 << (BCCParser.ID - 28)))) !== 0));
            this.state = 71;
...
BCCParser.prototype.factor = function() {
    ...
    try {
        ...
        case 7:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << BCCParser.T__0) | (1 << BCCParser.T__1) | (1 << BCCParser.TK_PAR_IZQ) | (1 << BCCParser.TK_INCREMENTO) | (1 << BCCParser.TK_DECREMENTO))) !== 0) || ((((_la - 50)) & ~0x1f) == 0 && ((1 << (_la - 50)) & ((1 << (BCCParser.NOT - 50)) | (1 << (BCCParser.NUM - 50)) | (1 << (BCCParser.FID - 50)) | (1 << (BCCParser.ID - 50)))) !== 0)) {
                this.state = 262;
                this.lexpr();
                this.state = 267;
                this._errHandler.sync(this);
