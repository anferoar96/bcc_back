...
prog : fndeclList* mainProg
     | EOF;       // match keyword
varDecl: ID TK_DOSPUNTOS datatype (TK_COMA ID TK_DOSPUNTOS datatype)*;
fndeclList: FUNCTION FID TK_DOSPUNTOS datatype TK_PAR_IZQ (varDecl)? TK_PAR_DER ( VAR varDecl TK_PUNTOYCOMA)? stmtBlock;
stmtBlock
...
nexpr
    : NOT TK_PAR_IZQ lexpr TK_PAR_DER
    | rexpr;
rexpr: simpleExpr ((TK_MENOR|TK_IGUALDAD|TK_MENOR_IGUAL|TK_MAYOR|TK_MAYOR_IGUAL|TK_DIFERENTE) simpleExpr)?;
